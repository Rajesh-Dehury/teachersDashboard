                ...
                <div class="col-md-12">
                    <div class="candleStickChartContainer">
                        ...
                        <script>
                            ...
                            const boxplotData = {
                                // define label tree
                                labels: ['Art & Culture', 'Social Science', 'Biology', 'Economic', 'Math', 'EVS', 'Physice', 'Chemistry', 'Computer', 'Literature'],
                                datasets: [{
                                        label: 'Art & Culture',
                                        backgroundColor: '#adcdea',
                                        borderColor: '#2d5597',
                                        borderWidth: 1,
                                        outlierColor: '#2d5597',
                                        padding: 40,
