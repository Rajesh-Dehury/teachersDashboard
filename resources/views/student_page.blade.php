                        ...
                        <div class="row m-2">
                            <div class="col-md-3">
                                <div class="profile-ellipse">
                                    <img src="/assets/teacher_dashboard_new/ab.jpg" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="font-weight-bold mt-2">Student's Name</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <p class="top-text">Top Pathway</p>
                                <div class="purple-box">
                                    <div class="white-box">
                                        <img class="img-fluid" src="/assets/teacher_dashboard_new/pathway.png">
                                    </div>
                                    <h4 class="font-weight-bold">Loreum</h4>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="blue-box">
                                    <div class="white-box">
                                        <img class="img-fluid" src="/assets/teacher_dashboard_new/interest/charity.png">
                                    </div>
                                    <h4 class="font-weight-bold">Art & Craft</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gray-box">
                        <div class="row m-2">
                            ...
                            <div class="col-md-6">
                                <p class="top-text">Top Interest</p>
                                <div class="blue-box">
                                    <h4 class="font-weight-bold">Charity</h4>
                                    <div class="white-box">
                                        <img class="img-fluid" src="/assets/teacher_dashboard_new/interest/charity.png">
                                    </div>
                                </div>
